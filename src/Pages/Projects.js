...
export default function Projects() {
    const pythongsvg = <svg className="technology-icon" width="20px" height="20px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <>
            ...
            <div className='reading-content'>
                <section>
                    <h2><a href='https://github.com/chrislawingco/imagepadder'>Image Padder {pythongsvg}</a></h2>
                    <div className='reading-content-section-body'>
                        <p className='reading-content-text'>
                            This is a description about the image padder project that I made to pad images with blank spaces.
                        </p>
                        <img className='reading-content-img-right' src='images/placeholder.jpg' />
                    </div>
                </section>

                <section>
                    <h2><a href='https://github.com/chrislawingco/totallyamazingbot'>totallyamazingbot {pythongsvg}</a></h2>
                    <div className='reading-content-section-body'>
                        <img className='reading-content-img-left' src='images/placeholder.jpg' />
                        <p>This is a description of the discord bot I made to practice python and whatever I felt like.</p>
                    </div>
                </section>
            </div>
